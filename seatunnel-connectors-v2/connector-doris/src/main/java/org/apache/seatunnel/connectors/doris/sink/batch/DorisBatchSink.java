...
public class DorisBatchSink extends AbstractSimpleSink<SeaTunnelRow, Void> {
    ...
    public AbstractSinkWriter<SeaTunnelRow, Void> createWriter(Context context) throws IOException {
        DorisBatchWriter dorisBatchWriter = new DorisBatchWriter(context, dorisConfig, seaTunnelRowType);
